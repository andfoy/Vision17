...
savename = sprintf('/home/andfoy/Documentos/Universidad/2017/VII_Semestre/Vision/Vision17/Lab9-HogDetection/src/eval_tools_mod/plot/figure/%s/wider_pr_cruve_%s_%s.pdf',dateset_class,seting_class,setting_name);
